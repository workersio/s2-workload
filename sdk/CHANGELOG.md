...
- Remove sdk url dependency ([#549](https://github.com/s2-streamstore/s2/issues/549))
...
- Roll back hyper to 1.9.0 ([#531](https://github.com/s2-streamstore/s2/issues/531))
...
- Remove start_after < prefix tests from Rust SDK ([#529](https://github.com/s2-streamstore/s2/issues/529))
...
- Inconsistent ack deadline semantics in append session ([#498](https://github.com/s2-streamstore/s2/issues/498))
...
- Remove redundant doc comment for `Encryption*` re-exports ([#489](https://github.com/s2-streamstore/s2/issues/489))
...
- Producer returns terminal err without draining ready acks ([#483](https://github.com/s2-streamstore/s2/issues/483))
...
- Support configurable rustls crypto provider ([#481](https://github.com/s2-streamstore/s2/issues/481))
...
- Panic on invariant checks involving acks from server  ([#473](https://github.com/s2-streamstore/s2/issues/473))
